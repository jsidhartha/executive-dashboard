...
const securityKPIs = [
    {
        ...
        value: 73, // percentage relative to 30m target → (22/30)*100 ≈ 73%
        target: "< 30m",
        type: "doughnut",
        color: "amber",
...
function renderAIOpsKPIs() {
    ...
    <div class="relative bg-${kpi.color}-50 border border-${kpi.color}-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
      ...
      <div class="mt-4 h-48 w-full">
        <canvas id="aiChart${i}"></canvas>
      </div>
      <p class="text-sm text-slate-600 mt-2">Target: ${kpi.target}</p>
    </div>
  `).join('');

    aiOpsKPIs.forEach((kpi, i) => {
        const ctx = document.getElementById(`aiChart${i}`).getContext("2d");
            ...
            new Chart(ctx, {
                ...
                options: {
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: `${kpi.value}${kpi.title.includes('%') ? '%' : ''}`,
                            color: "rgb(31,41,55)",
                            font: { size: 22, weight: "bold" },
                            position: "center"
                        }
        ...
        if (kpi.type === "bar") {
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: kpi.value,
                        backgroundColor: `rgba(${kpi.color === 'rose' ? '244,63,94' : '16,185,129'},0.6)`,
                        borderRadius: 6
                    }]
                },
                options: {
...
function renderIncidentKPIs() {
    ...
    <div class="relative bg-${kpi.color}-50 border border-${kpi.color}-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
      ...
      <div class="mt-4 h-40 w-full">
        <canvas id="incidentChart${i}"></canvas>
      </div>
  ...
  `).join('');
    ...
    incidentKPIs.forEach((kpi, i) => {
        const ctx = document.getElementById(`incidentChart${i}`).getContext("2d");
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [kpi.value, 100 - kpi.value],
                        backgroundColor: [
                            `rgba(${kpi.color === 'emerald' ? '16,185,129' : kpi.color === 'rose' ? '244,63,94' : '251,191,36'},0.9)`,
                            "rgba(229,231,235,0.4)"
                        ],
                        borderWidth: 0,
                        cutout: "70%"
        ...
        if (kpi.type === "bar") {
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: kpi.value,
                        backgroundColor: `rgba(${kpi.color === 'emerald' ? '16,185,129' : '251,191,36'},0.6)`,
                        borderRadius: 6
                    }]
                },
                options: {
        ...
        if (kpi.type === "line") {
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: kpi.value,
                        borderColor: `rgba(${kpi.color === 'rose' ? '244,63,94' : '251,191,36'},1)`,
                        backgroundColor: `rgba(${kpi.color === 'rose' ? '244,63,94' : '251,191,36'},0.2)`,
                        fill: true,
                        tension: 0.4,
                        pointRadius: 4,
                        pointHoverRadius: 6
    ...
    financeKPIs.forEach((kpi, i) => {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [kpi.value, 100 - kpi.value],
                        backgroundColor: [
                            `rgba(${kpi.color === 'rose' ? '244,63,94' : '16,185,129'}, 0.9)`,
                            "rgba(229,231,235,0.4)"
                        ],
                        borderWidth: 0,
                        cutout: "70%"
        ...
        if (kpi.type === "bar") {
            new Chart(ctx, {
                type: "bar",
                data: {
                    labels: kpi.labels || ["Jan", "Feb", "Mar", "Apr", "May", "Jun"],
                    datasets: [{
                        data: kpi.value || kpi.values,
                        backgroundColor: `rgba(${kpi.color === 'amber' ? '251,191,36' : '16,185,129'},0.6)`,
                        borderRadius: 6
                    }]
                },
                options: {
...
// === Solutions Consulting KPI Data (Enhanced) ===
const solutionsKPIs = [
    {
        title: "Win Rate",
        value: 30,
        ...
        if (kpi.type === "line") {
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: kpi.value,
                        borderColor: `rgba(${kpi.color === 'green' ? '5,150,105' : '251,191,36'},1)`,
                        backgroundColor: `rgba(${kpi.color === 'green' ? '5,150,105' : '251,191,36'},0.2)`,
                        fill: true,
                        tension: 0.4,
                        pointRadius: 4,
                        pointHoverRadius: 6
